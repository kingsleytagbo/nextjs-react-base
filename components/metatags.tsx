...
const Meta = (props: any) => (
    <Head>
        ...
        <meta property="og:site_name" content={process.env.NEXT_PUBLIC_REACT_APP_WEBSITE_NAME} />
        {
            props.canonical &&
...

{
            ...
            <meta name="robots" content="noindex,nofollow" />
                ...
                {
            props.image &&
            <meta property="og:image" content={`${props.image || process.env.NEXT_PUBLIC_REACT_APP_WEBSITE_URL_IMAGE_BACKGROUND}`} />
        }
        ...
        {
            props.image &&
            <meta name="twitter:image" content={`${props.image || process.env.NEXT_PUBLIC_REACT_APP_WEBSITE_URL_IMAGE_BACKGROUND}`} />
        }
